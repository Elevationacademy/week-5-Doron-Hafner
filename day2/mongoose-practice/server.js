...
// Person.find({numKids: {$gte: 0}, 'kids.hair': 'grey'}, (err, person) => console.log(person))
// Person.findById('5f57c7407dd1391d4a5ca760', 'kids.hair',(err, person) => console.log(person))//test
// // 5. Find all the people who have at least one overweight kid, and are overweight themselves (>100)
// Person.find({'kids.weight': {$gte: 100}, weight: {$gte: 100}}, (err, person) => console.log(person))
